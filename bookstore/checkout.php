...
<blockquote>
	...
	<input class="hi" style="float: right; margin: 2%;" type="button" name="cancel" value="Anasayfa" onClick="window.location='index.php';" />
</blockquote>
</header>
<?php
session_start();
...
<?php
	echo '<h2 style="color: #000;">Sipariş Başarılı:</h2>';
	...
	echo "<tr><td style='background-color: #ccc;'></td><td style='text-align: right;background-color: #ccc;''>Toplam : <b>TL = ".$total."</b></td></tr>";
	echo "</table>";
	echo "</div>";
...
if(!isset($_SESSION['id'])){
	...
	echo 'Kullanıcı Adı:<br><input type="text" name="name" placeholder="">';
	echo '<span class="error" style="color: red; font-size: 0.8em;"><?php echo $nameErr;?></span><br><br>';

	echo 'E-mail:<br><input type="text" name="email" placeholder="">';
	echo '<span class="error" style="color: red; font-size: 0.8em;"><?php echo $emailErr;?></span><br><br>';

	echo 'Telefon Numarası:<br><input type="text" name="contact" placeholder="">';
	echo '<span class="error" style="color: red; font-size: 0.8em;"><?php echo $contactErr;?></span><br><br>';

	echo '<label>Cinsiyet:</label><br>';
	echo '<input type="radio" name="gender" if (isset($gender) && $gender == "Male") echo "checked"; value="Male">Kadın';
	echo '<input type="radio" name="gender" if (isset($gender) && $gender == "Female") echo "checked"; value="Female">Erkek';
	echo '<span class="error" style="color: red; font-size: 0.8em;"><?php echo $genderErr;?></span><br><br>';

	echo '<label>Adres:</label><br>';
	   echo '<textarea name="address" cols="30" rows="5" placeholder="Adres"></textarea>';
...
<?php
	echo '<input class="button" type="submit" name="submitButton" value="Tamamla">';
	echo '</form><br><br>';
}
